...
if (isset($_POST["register"])) {
    ...
    if (empty($name) || empty($address) || empty($mobile) || empty($email) || empty($password)) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO customer (name, address, mobile, email, password) VALUES (?, ?, ?, ?, ?)";
    ...
    <div class="container-fluid">
        <form class="mx-auto" action="registration.php" method="post" autocomplete="off">
            ...
            <div class="mb-3 mt-2">
                ...
                <input type="text" class="form-control" id="city" name="address" placeholder="Enter your Address" required>
            </div>
